...
export default function LoginModal({ isOpen, onClose, LoginRef }) {
  const { isVisible, toggleVisibility, field, handleChange, handleSubmit } =
    useHook();
  ...
  return (
    <Modal
      ...
      placement="center"
      classNames={{
        base: "bg-[#e6e6e6] dark:bg-[#181818] rounded-[24px] shadow-2xl dark:shadow-zinc-950/50",
        backdrop: "bg-black/50 backdrop-blur-md h-full",
        closeButton:
          "hover:bg-gray-100 active:bg-gray-200 dark:hover:bg-zinc-800 dark:active:bg-zinc-700 top-4 right-4 text-gray-400 absolute transition-colors",
      }}
    >
      <ModalContent ref={LoginRef}>
        {(onClose) => (
          <form onSubmit={handleSubmit}>
            ...
            <ModalBody className="px-8 py-2 mt-2">
              <div className="space-y-10">
                <Input
                  ...
                  classNames={{
                    inputWrapper:
                      "border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 hover:border-gray-300 dark:hover:border-zinc-500 focus-within:!border-[#111827] dark:focus-within:!border-zinc-300 focus-within:!ring-1 focus-within:!ring-[#111827] dark:focus-within:!ring-zinc-300 transition-all rounded-xl shadow-sm",
                    label:
                      "text-gray-700 dark:text-zinc-300 font-semibold text-xs tracking-wider",
              ...
              <div className="flex justify-end mt-2">
                <a
                  href="#"
                  className="text-xs font-medium text-gray-500 dark:text-zinc-400 hover:text-[#111827] dark:hover:text-zinc-200 transition-colors"
                >
                  Forgot password?
                </a>
              </div>
