    ...
    <main className="min-h-screen relative flex flex-col items-center justify-center  overflow-hidden bg-[#fafafa] dark:bg-[#0a0a0a] text-black dark:text-white transition-colors duration-500">
      ...
      <section className="relative z-10 flex flex-col items-center text-center px-6 max-w-4xl w-full">
        <div className="mb-8 flex flex-col items-center select-none">
          <h1 className="text-4xl md:text-6xl  font-light tracking-widest text-[#111] dark:text-[#f4f4f5] uppercase mb-6 opacity-90 drop-shadow-sm">
            Consent Form
          </h1>
          <div className="h-[1px] w-[100px] bg-black dark:bg-white mb-6 "></div>
        ...
        <Button
          ...
          className="group relative overflow-hidden bg-[#111] text-white hover:bg-black dark:bg-[#f4f4f5] dark:text-black dark:hover:bg-white font-medium tracking-[0.2em] uppercase text-sm px-16 py-6 transition-all hover:shadow-2xl hover:-translate-y-0.5"
        >
