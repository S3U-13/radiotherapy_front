...
export default function Navbar() {
  return (
    <div className="h-20 p-2 flex justify-between items-center px-6">
      <Image alt="PPK logo" src="/images/logoppk.png" width={50} />
      ...
      <div className="flex items-center gap-5">
        ...
        <Dropdown placement="bottom-end">
          <DropdownTrigger>
            <Button className="bg-white" isIconOnly radius="full" size="md">
